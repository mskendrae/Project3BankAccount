...
namespace Project3BankAccount
{
    class Savings:Account
    {
        ...
        public override void Withdraw(Account savingsAccount)
        {
            ...
            StreamWriter withdraw = new StreamWriter("savings.txt", true);
            withdraw.WriteLine(DateTime.Now + " - $" + userWithdraw + " $" + this.savingsBalance);
            withdraw.Close();
        ...
        public override void Deposit(Account savingsAccount)
        {
            ...
            Console.WriteLine();
            StreamWriter withdraw = new StreamWriter("savings.txt", true);
            withdraw.WriteLine(DateTime.Now + " + $" + userDeposit + " $" + this.savingsBalance);
            withdraw.Close();
        } //end deposit method
